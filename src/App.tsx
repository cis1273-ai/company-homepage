...
const caseStudies = [
  ...
  },
  {
    ...
    result: '항공보안파트너즈 → 한국공항보안 사명변경 및 전략, 조직구조 개편, 본사 및 현장조직 적정인력산정, 조직문화 개선, 노사관계 개선, 조직 및 개인평가제도 개선, 급여체계 개선, 중장기 재무목표 및 관리방안 수립 등 전반적인 경영시스템 고도화 확립',
  },
  {
    num: '05',
    client: '경상남도사회서비스원',
