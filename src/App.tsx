    ...
    <div className="min-h-screen bg-[#fbf9f8]">
      ...
      <div className="bg-[#001736] px-6 py-4 flex justify-between items-center">
        <div className="flex items-center gap-3">
          <span className="text-white font-bold text-lg tracking-wide">관리자 대시보드</span>
        </div>
    ...
    <section className="relative bg-primary text-white py-24 md:py-36 px-4 md:px-6 overflow-hidden">
      ...
      <div className="relative max-w-[1200px] mx-auto flex flex-col gap-6 md:gap-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-8">
          ...
          <a href="/ai-hr-system.pdf" target="_blank" rel="noopener noreferrer" className="border border-white text-white px-8 py-4 rounded hover:bg-white hover:text-primary font-semibold transition-colors text-lg text-center block">AI HR System</a>
        </div>
      </div>
    </section>
  );
