    ...
    <section className="relative bg-primary text-white py-24 md:py-36 px-4 md:px-6 overflow-hidden">
      ...
      <div className="relative max-w-[1200px] mx-auto flex flex-col gap-6 md:gap-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-8">
          <a href="/ai-hr-system.pdf" target="_blank" rel="noopener noreferrer" className="bg-secondary text-white px-8 py-4 rounded hover:bg-[#004f9b] font-semibold transition-colors text-lg text-center block">AI HR System</a>
