    ...
    <section className="relative bg-primary text-white py-24 md:py-36 px-4 md:px-6 overflow-hidden">
      ...
      <div className="relative max-w-[1200px] mx-auto flex flex-col gap-6 md:gap-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-8">
          ...
          <a href="/company-profile.pptx" target="_blank" rel="noopener noreferrer" className="border border-white text-white px-8 py-4 rounded hover:bg-white hover:text-primary font-semibold transition-colors text-lg text-center block">회사 소개서</a>
        </div>
      </div>
    </section>
  );
